                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-success btn-diagnosa m-2"
                                                data-id_diagnosa="{{ $data->id }}">Tindakan Medis</button>
                                            @endif
                                            <button class="btn btn-info btn-show m-2"
                                                data-id_show="{{ $data->pelayanan_id }}">Show</button>
            ...
            <script type="text/javascript">
                $(function () {
                  ...
                  $(document).on('click', '.btn-diagnosa', function (e) {
                   ...
                   Swal.fire({
                            title: `Tindakan Medis Pasien - ${name}`,
                            html:
                                '<input id="diagnosa" class="swal2-input" placeholder="Tindakan Medis">' +
