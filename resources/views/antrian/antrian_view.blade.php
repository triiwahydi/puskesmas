                                ...
                                <table id="table_antrian" class="table table-bordered table-striped"
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($antrian as $data)
                                            <tr>
                                                <td>{{ $i++ }}</td>
                                                <td>{{ \Carbon\Carbon::parse($data->created_at)->format('d-m-Y H:i:s') }}
                                                </td>
                                                <td class="no_antrian">{{ $data->no_antrian }}</td>
                                                <td>{{ $data->nik }}</td>
                                                ...
                                                <td>
                                                    ...
                                                    <button class="btn btn-warning btn-pelayanan m-2"
                                                        data-id_pelayanan="{{ $data->pasien_id }}"
                                                        data-id_antrian="{{ $data->id }}">Pelayanan</button>
                ...
                <script>
                    ...
                    $(document).ready(function() {
                        ...
                        $('.btn-panggil').click(function() {
                            // update data 
                            var no_antrian = $(this).closest('tr').find('.no_antrian').text();
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    ...
                                    msg.text = "Nomor antrian: ,";
                                    for (let i = 0; i < no_antrian.length; i++) {
                                        msg.text += no_antrian[i] + " , ";
                                    }
